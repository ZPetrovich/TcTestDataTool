 ...
 *   <ol>
 *     <li>Added {@link #MARATHON_MATCH_ID} item.</li>
 *     <li>Added {@link #CONTEST_FEE_PERCENTAGE} item.</li>
 *   </ol>
 * </p>
 *
 * @author isv
...
public enum ProjectInfoType {
    ...
    MARATHON_MATCH_ID(56, "Marathon Match ID", false),
    
    CONTEST_FEE_PERCENTAGE(57, "Contest Fee Percentage", false);
