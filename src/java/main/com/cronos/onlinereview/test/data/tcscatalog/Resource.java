 ...
 *   <ol>
 *     <li>Added {@link #getUserId()} method. (1.1.1.2)</li>
 *   </ol>
 * </p>
 *
 * @author isv
...
public class Resource implements Serializable {
    ...
    /**
     * <p>Gets the ID for a user associated with this resource.</p>
     * 
     * @return a <code>long</code> providing the ID for a user associated with this resource.
     */
    public long getUserId() {
        if (getUser() != null) {
            return getUser().getUserId();
        } else {
            return getTopCoderUser().getUserId();
        }
    }
}
