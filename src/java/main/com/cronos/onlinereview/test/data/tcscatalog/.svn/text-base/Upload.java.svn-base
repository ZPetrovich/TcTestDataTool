 ...
 *
 * <p>
 * Version 1.1 (Release Assembly - TopCoder System Test Data Generator Update 2 Assembly 1.0) Change notes:
 *   <ol>
 *     <li>Added {@link #projectPhaseId} property. (1.1.4#3)</li>
 *   </ol>
 * </p>
 * 
 * @author isv
...
public class Upload implements Serializable {
    ...
    /**
     * <p>A <code>Long</code> providing the ID of a project phase which this upload corresponds to.</p>
     * 
     * @since 1.1
     */
    ...
    /**
     * <p>Gets the ID of a project phase which this upload corresponds to.</p>
     *
     * @return a <code>Long</code> providing the ID of a project phase which this upload corresponds to.
     * @since 1.1
     */
    ...
    /**
     * <p>Sets the ID of a project phase which this upload corresponds to.</p>
     *
     * @param projectPhaseId a <code>Long</code> providing the ID of a project phase which this upload corresponds to.
     * @since 1.1
     */
